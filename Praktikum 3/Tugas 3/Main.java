...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Menu menu = null;
            if (pilihanMenu == 1) {
                // Tetapkan menu yang dipilih ke menu1
                menu = menu1;
            } else if (pilihanMenu == 2) {
                // Tetapkan menu yang dipilih ke menu2
                menu = menu2;
                
            } else {
                // Tampilkan pesan bahwa menu tidak valid dan menghentikan eksekusi program
                System.out.println("Menu tidak valid");   
            }
            
            // Periksa apakah menu yang dipilih tidak null, jika null, seharusnya menimbulkan (throw) MenuTidakTersediaException
            if (menu == null){
